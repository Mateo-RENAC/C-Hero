...
namespace C_Hero.Migrations
{
    ...
    [Migration("20240926073142_SuperVillain Conflit")]
    partial class SuperVillainConflit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("C_Hero.Models.Entities.SuperVillainModel", b =>
                {
                    ...
                    b.Property<Guid?>("IncidentModelIncidentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IncidentModelIncidentId");
            ...
            modelBuilder.Entity("C_Hero.Models.Entities.SuperVillainModel", b =>
                {
                    ...
                    b.HasOne("C_Hero.Models.Entities.IncidentModel", null)
                        .WithMany("Villains")
                        .HasForeignKey("IncidentModelIncidentId");
